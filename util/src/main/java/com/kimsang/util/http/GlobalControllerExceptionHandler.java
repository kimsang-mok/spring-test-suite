...
import com.kimsang.api.exceptions.BadRequestException;
...
class GlobalControllerExceptionHandler {
  ...
  public @ResponseBody HttpErrorInfo handleNotFoundExceptions(
          org.springframework.http.server.reactive.ServerHttpRequest request, NotFoundException ex) {
  ...
  private HttpErrorInfo createHttpErrorInfo(
          HttpStatus httpStatus, org.springframework.http.server.reactive.ServerHttpRequest request, Exception ex) {
